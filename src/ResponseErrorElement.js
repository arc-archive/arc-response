...
import elementStyles from './styles/Error.styles.js';
import {
  pageTemplate,
  messageChanged,
  messageValue,
  ...
  render() {
    ...
    <div class="message-wrapper">
      ...
      <div class="error-desc">
        ${this[pageTemplate](detailsPage, message)}
      </div>
    </div>
    `;
  }
    ...
    switch (selected) {
      ...
      case 4:
        return html`
          <section>
            <h3>Abort / timeout</h3>
            <p>
              The request has been aborted manually or because of the connection timeout. There were no response from the
      ...
      case 16:
        return html`
          <section>
            <h3>The requested URL can’t be reached</h3>
            <p>This site on the company, organization or school intranet has the same URL as an external website.</p>
